...
<body>
	...
	<section class="page-top-info set-bg" data-setbg="img/page-top-bg/2.jpg">
		<div class="ptf-center">
			<div class="container">
				<h2>Create Transactions<span>.</span></h2>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-lg-6 offset-lg-6 featured">
					<div class="section-title st-no-style text-left">
						...
						<form name="createtrans" action="m1_create/m1_createprocessing_submit.jsp" method="POST">
                                                    
                            <label for="transno">Transaction Number</label>
                            <input type="text" class="form-control" id="transno" placeholder="000000000" name ="transno">
							...
							<input type="submit" class="btn btn-secondary site-btn my-btn" name="trans" value="Create Transaction">
