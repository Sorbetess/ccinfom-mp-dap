...
<html lang="zxx">
<head>
	<title>Search and Display Transactions</title>
	<meta charset="UTF-8">
		...
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="img/slider/slider-2.jpg">
				<div class="hs-content">
					<div class="hsc-warp">
						<h2>Search and display Transactions<span>.</span></h2>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="inter-section spad">
		<div class="container">
			<div class="section-title">
				...
				<h2>Display transaction details</h2>
			</div>
			<form name="searchtrans" action="m1_search/m1_searchprocessing_submit.jsp" method="POST" class="col-12">
